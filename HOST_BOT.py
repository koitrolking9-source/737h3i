...
@app.route('/')
def home():
    return "STRONXIUM HOSTING BOT IS NOW RUNNING......................."
...
# --- Configuration ---
TOKEN = '8690308551:AAGdtSZe47xHVc2hyJGs8KA436qEYSyQf1g' # Replace with your actual token
OWNER_ID = '7811364879'# Replace with your Owner ID
ADMIN_ID = '7811364879' # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@Stronxium' # Replace with your Telegram username (without the @)
